				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/" method="POST" action="{{ route('register') }}">
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6"> {{__('Your Social Campaigns')}}</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading-->
								<!--begin::Login options-->
								<div class="row g-3 mb-9">
									...
									<div class="col-md-6">
										...
										<img alt="Logo" src="assets/media/svg/brand-logos/google-icon.svg" class="h-15px me-3" /> {{__('Sign in with Google')}}</a>
										<!--end::Google link=-->
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-md-6">
										...
										<img alt="Logo" src="assets/media/svg/brand-logos/apple-black-dark.svg" class="theme-dark-show h-15px me-3" /> {{__('Sign in with Apple')}}</a>
										<!--end::Google link=-->
									</div>
									<!--end::Col-->
								</div>
					...
					<div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
						...
						<div class="d-flex fw-semibold text-primary fs-base gap-5">
							<a href="../../demo6/dist/pages/team.html" target="_blank">Terms</a>
							<a href="../../demo6/dist/pages/pricing/column.html" target="_blank">Plans</a>
							<a href="../../demo6/dist/pages/contact.html" target="_blank">Contact Us</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
