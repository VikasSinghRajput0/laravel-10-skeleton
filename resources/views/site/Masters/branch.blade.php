                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#modal_add_Branch">Add Branch</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form class="form" id="BranchForm" data-kt-redirect="">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="modal_add_Branch_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#modal_add_Branch_header"
                            data-kt-scroll-wrappers="#modal_add_Branch_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid BranchName" placeholder="Branch Name"
                                    name="name" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid BranchCode" placeholder="Branch Code"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" id="editBranchForm" data-kt-redirect="">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="modal_edit_Branch_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#modal_edit_Branch_header"
                            data-kt-scroll-wrappers="#modal_edit_Branch_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                            <div class="fv-row mb-15">
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold mb-2">Region</label>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <!--end::Label-->
                                <!--begin::Select 2-->
                                <input type="text" class="form-control form-control-solid BranchCountry" placeholder=""
